                ...
                <div className="pr-4 text-gray-200 text-sm">
                    <div className="mt-2">
                        <p className="mt-4">
                            ...
                            or 'our'), describes how and why we might collect,
                        ...
                        <ul className="mt-4">
                            <li>
                                Visit our website at www.minecraftmagic.com, or
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            ...
                            to process your payment if you choose to make
                        ...
                        <p className="mt-4">
                            <b>Social Media Login Data.</b> We may provide you
                            with the option to register with us using your
                            existing social media account details, like your
                            Github, Google, or other social media account. If
                            you choose to register in this way, we will collect
                            certain profile information about you from the
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            <b>In Short:</b> We process your information to
                        ...
                        <ul className="mt-4 list-disc space-y-3 ml-4">
                            ...
                            <li>
                                <b>To protect our Services.</b> We may process
                                your information as part of our efforts to keep
                                our Services safe and secure, including fraud
                    ...
                    <div className="mt-6">
                        <h2 className="text-lg font-bold">
                            What legal basis do we have for processing your
                            information?
                        </h2>
                        <p className="mt-4">
                            <b>In Short:</b> We only process your personal
                            information when we believe it is necessary and we
                            have a valid legal reason (i.e. legal basis) to do
                            so under applicable law, like with your consent, to
                            comply with laws, to provide you with services to
                            enter into or fulfil our contractual obligations, to
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            <b>In Short:</b> We may share information in
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            <b>In Short:</b>We may use cookies and other
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            <b>In Short:</b>We keep your information for as long
                    ...
                    <div className="mt-6">
                        <h2 className="text-lg font-bold">
                            Protecting the Information of Users Under 13
                        </h2>
                        <p className="mt-4">
                            <b>In Short:</b> Our Service does not address anyone
                            under the age of 13, and we do not knowingly collect
                            personally identifiable information from users under
                            this age.
                        </p>
                        <p className="mt-4">
                            We are committed to protecting the privacy of
                            children. Our Service is not intended for anyone
                            under the age of 13. We do not knowingly collect
                            personal information from children under 13. If you
                            are a parent or guardian and you become aware that
                            your child has provided us with personal data,
                            please contact us immediately. If we discover that
                            we have collected personal data from a child under
                            13 without parental consent, we will take steps to
                            delete that information from our servers promptly.
                        </p>
                    </div>
                </div>
            </Guest>

        ...
        <>
            ...
            <Guest>
                ...
                <div className="pr-4 text-sm text-gray-200">
                    <div className="mt-2">
                        <p className="mt-4">
                            We are MinecraftMagic ("Company," "we," "us,"
                            "our"). We operate , as well as any other related
                            products and services that refer or link to these
                            legal terms (the "Legal Terms") (collectively, the
                            "Services"). You can contact us by email at
                            contact@minecraftmagic.com.
                        </p>
                        <p className="mt-4">
                            These Legal Terms constitute a legally binding
                            agreement made between you, whether personally or on
                            behalf of an entity ("you"), and MinecraftMagic,
                        ...
                        <p className="mt-4">
                            ...
                            date of these Legal Terms, and you waive any right
                            to receive specific notice of each such change. It
                            is your responsibility to periodically review these
                            Legal Terms to stay informed of updates. You will be
                    ...
                    <div className="mt-6">
                        ...
                        <ul className="ml-4 mt-4 list-disc space-y-3">
                            ...
                            <li>
                                ...
                                Content to which you have properly gained
                                access.
                            </li>
                        </ul>
                        <p className="mt-4">
                    ...
                    <div className="mt-6">
                        ...
                        <ul className="ml-4 mt-4 list-disc space-y-3">
                            <li>
                                ...
                                publish, upload, or transmit through the
                                Services any Submission that is illegal,
                                harassing, hateful, harmful, defamatory,
                            ...
                            <li>
                                ...
                                have full authority to grant us the
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            ...
                            that: (1) you have the legal capacity and you agree
                            to comply with these Legal Terms; (2) you are not a
                            ...
                            illegal or unauthorized purpose; and (5) your use of
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            ...
                            PARTICIPATION IN THE SERVICES OR DELETE ANY CONTENT
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            ...
                            information on our Services. We also reserve the
                            right to modify or discontinue all or part of the
                            Services without notice at any time. We will not be
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">
                            ...
                            AMOUNT PAID, IF ANY, BY YOU TO US OR . CERTAIN US
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-4">contact@minecraftmagic.com</p>
                    </div>
                </div>
            </Guest>
        </>
